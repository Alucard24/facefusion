...
MODELS : ModelSet =\
{
    ...
    {
		'url': 'https://github.com/Alucard24/facefusion-assets/releases/download/v1.0.1/realesr-general-x4v3.onnx',
		'path': resolve_relative_path('../.assets/models/realesr-general-x4v3.onnx'),
		'size': (64, 8, 2),
		'scale': 4
	},
